...
public class Rechnung {
  @NotBlank private String rechnungsnummer;

  @NotBlank private String aussteller;

  @NotBlank private String empfaenger;
  ...
  @NotNull @Positive private BigDecimal gesamtBetrag;

  @NotNull private LocalDateTime faelligkeitsdatum;

  @NotNull private LocalDateTime rechnungsdatum;
  ...
  public Rechnung(
    ...
    if (summe.compareTo(gesamtBetrag) != 0) {
      throw new IllegalArgumentException(
          "Summe falsch. Einzelene Positionen: " + summe + " Gesamtbetrag: " + gesamtBetrag);
    }
  }
...
class Position {
  @NotBlank private String artikelnummer;

  @Positive private double menge;

  @NotNull @Positive private BigDecimal einzelpreis;
