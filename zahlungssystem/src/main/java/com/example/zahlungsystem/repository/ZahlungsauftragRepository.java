...
public class ZahlungsauftragRepository {
    ...
    public ZahlungsauftragRepository(final DataSource dataSource) {this.dataSource = dataSource;}
    ...
    private void insertZahlungsauftrag(final Connection conn, final Zahlungsauftrag auftrag) throws SQLException {
    ...
    public void updateStatus(java.sql.Connection conn, String ref, ZahlungsStatusType status) throws SQLException {
