    ...
    private void processMessage(Channel channel, long tag, String message) {
        ...
        try {
            ...
            try (java.sql.Connection conn = DatabaseConfig.getInstance().getConnection()) {
                ...
                logger.info("Zahlungsauftrag in Datenbank registriert. Referenz: {}, Status: AUSSTEHEND", ref);
                ...
                if (erfolg) {
                    ...
                    logger.info("Zahlvorgang erfolgreich abgeschlossen. Referenz: {}, Status: ABGESCHLOSSEN", ref);
                } else {
